...
class DCoL(BaseMetric):
    ...
    def _dataset_to_arff(self):
        ...
        arff.dump("/tmp/tmp.arff", acc, relation="relation name", names=list(df.columns) + ["class"])
    ...
    def get_complexity(self) -> Float:
        ...
        subprocess.call(["dcol", "-i", ds_path, "-o", "/tmp/dcol_output", f"-{self.metric}", self.variant, "-xml"])
